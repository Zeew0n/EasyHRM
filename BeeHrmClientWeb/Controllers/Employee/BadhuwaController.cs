...
{
    public class BadhuwaController : BaseController
    {
        ...
        [Route("badhuwa/{empCode}")]
        [HttpPost]
        public ActionResult Badhuwa(int empCode, EmployeeJobHistoryViewModel data)
        {
            if (!ViewBag.AllowView)
            {
                ViewBag.Error = "You are not Authorize to use this Page";
            ...
            try
            {
                ...
                {
                    return View("../Employee/Badhuwa/Index", data);
                }
                ...
                int res = _jobHistoryService.InsertJobHistoryForBadhuwa(dataToInsert);
